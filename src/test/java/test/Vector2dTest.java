...
public class Vector2dTest {
    ...
    public void testPrecedes() {
        assertTrue(v_1_2.precedes(this.v_2_3));
        assertFalse(v_2_3.precedes(this.v_1_2));
        assertFalse(v_1_3.precedes(this.v_1_2));
        assertTrue(v_1_2.precedes(this.v_1_3));
    }

    @Test
    public void testFollows() {
        assertFalse(v_1_2.follows(v_2_3));
        assertTrue(v_2_3.follows(v_1_2));
        assertTrue(v_1_3.follows(v_1_2));
        assertFalse(v_1_2.follows(v_1_3));
